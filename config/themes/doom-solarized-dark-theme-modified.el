;;; doom-solarized-dark-modified-theme.el --- inspired by VS Code Solarized Dark -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-solarized-dark-modified-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-solarized-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-solarized-dark-modified-theme
  :type 'boolean)
...
;;; doom-solarized-dark-modified-theme.el ends here
