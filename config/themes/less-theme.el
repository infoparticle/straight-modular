...
(custom-theme-set-faces
 ...
 '(font-lock-constant-face
   ((((class grayscale)
      (background light))
     (:underline
      (:color foreground-color :style line) :weight bold :foreground "LightGray"))
    (((class grayscale)
      (background dark))
     (:underline
      (:color foreground-color :style line) :weight bold :foreground "Gray50"))
    (((class color)
      (min-colors 88)
      (background light))
    ...
    (t
     (:underline
      (:color foreground-color :style line) :weight bold))))
 ...
 '(link
   ((((class color)
    ...
    (((class color)
      (background light))
     (:underline
      (:color foreground-color :style line) :foreground "blue"))
    (((class color)
      (min-colors 88)
      (background dark))
     (:underline
    ...
    (((class color)
      (background dark))
     (:underline
      (:color foreground-color :style line) :foreground "cyan"))
    (t
     (:inherit
      (underline)))))
 ...
 '(tooltip
   ((((class color))
     (:inherit
      (variable-pitch) :foreground "black" :background "lightyellow"))
    (t
     (:inherit
      (variable-pitch)))))
 ...
 '(org-block-begin-line
   ((t
     (:background nil :foreground "gainsboro" :underline nil ))))
 '(org-block-end-line
   ((t
     (:background nil :foreground "gainsboro" :overline nil))))
 '(org-document-info-keyword
   ((t
     (:background nil :foreground "gainsboro"))))
 '(org-meta-line
   ((t
     (:background nil :foreground "gainsboro"))))
 '(org-level-1
   ((t
     (:weight bold :foreground "RoyalBlue3" ))))
 '(org-document-title
   ((t
     ( :foreground "DarkBlue" :weight bold :height 1.5))))
 '(org-link
   ((t
     (:foreground "royalblue3" :background "white smoke" :underline nil))))
 )
